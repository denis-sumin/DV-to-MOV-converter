...
extern "C" unsigned int __cdecl Var32x32_iSSE(const unsigned char *pSrc, int nSrcPitch, int *pLuma);
extern "C" unsigned int __cdecl Var16x32_iSSE(const unsigned char *pSrc, int nSrcPitch, int *pLuma);
...
extern "C" unsigned int __cdecl Luma32x32_iSSE(const unsigned char *pSrc, int nSrcPitch);
extern "C" unsigned int __cdecl Luma16x32_iSSE(const unsigned char *pSrc, int nSrcPitch);
