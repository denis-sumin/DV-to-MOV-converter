 ...
 */
class MVBlockFps : public GenericVideoFilter, public MVFilter {
private:
...
public:
	MVBlockFps(PClip _child, PClip _super, PClip _mvbw, PClip _mvfw, unsigned int _num, unsigned int _den,
                int _mode, int _thres,
