...
movntq [edi+eax*4-16],mm0 ;store ; bug fixed in v1.2.2, replaced by faster movntq in 2.5.1
cmp eax,ecx
movntq [edi+eax*4-8],mm3   ;store  ; bug fixed in v1.2.2
jl xloop
add ebx,pitch1Y
add edx,pitch1UV
add esi,pitch1UV
