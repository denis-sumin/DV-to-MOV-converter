...
//   PClip pelclip;
   ...
   PClip finest; // v2.0
	...
	BYTE *framesY; //Chainik: all Y vectors is now here
	BYTE *framesUV;//and all UV masks - here
   ...
   int *LUTYOffset; // luckup table for vy memory offset
   ...
   SimpleResize *upsizerUV;
	...
	void Create_LUTYOffset(int time256, int *LUTYOffset, int ref_pitch);
